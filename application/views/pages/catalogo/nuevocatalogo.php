...
<main class="mdl-layout__content mdl-color--grey-100">
    <div class="contenedor">        
        <div class=" row TextColor center"><div class="col s5 m8 l12 offset-m1">creación de catalogos</div></div>
            ...
            <?php 
                if($bandera!=0) { 
                    echo '<div class="bold col s5 m8 l2">
                          ...
                          <i class="material-icons right">insert_invitation</i>CREAR</a></div>';
                } 
            ?>
...
<div id="listaArticulosCatalogoActual" class="modal">
    ...
    <div class="modal-content">
        ...
        <div class="row center"><a id="guardarCatalogo" class="redondo waves-effect waves-light btn">GUARDAR</a></div>         
    </div>
</div>
...
<div id="listaArticulos" class="modal">
    ...
    <div class="modal-content">
        <div class="row TextColor center"><div class="col s5 m8 l12 offset-m1">reutilización de catálogo</div></div>
...
<div id="darBaja" class="modal">
    ...
    <div class="modal-content">
      ...
      <div class="row center"><a id="darBajaOK" class="redondo waves-effect waves-light btn">ACEPTAR</a></div>         
    </div>
</div>
...
<div id="modalNuevoCatalogo" class="modal">
    ...
    <div class="modal-content">
        <div class="row TextColor center"><div class="col s5 m8 l12 offset-m1">creación de nuevo catalogo</div>
    </div>
    ...
    <div class="row center"><a id="CrearCatalogo" class="redondo waves-effect waves-light btn">GUARDAR</a></div></div>
</div>